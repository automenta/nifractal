...
public class Nifty {
  ...
  private void initalizeEventBus() throws EventServiceExistsException {
    EventServiceLocator.setEventService(name, new ThreadSafeEventService());
  }
  ...
  public void subscribeAnnotations(final Object object) {
    NiftyEventAnnotationProcessor.process(name, object);
  }

  public void unsubscribeAnnotations(final Object object) {
    NiftyEventAnnotationProcessor.unprocess(name, object);
  }
